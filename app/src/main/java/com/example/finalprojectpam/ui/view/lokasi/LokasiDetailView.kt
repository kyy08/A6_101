...
import com.example.finalprojectpam.ui.viewmodel.lokasi.DetailUiState
...
fun LokasiDetailView(
    ...
    viewModel.getLokasiById(id_lokasi)
...
fun DetailBody(
    ...
    when (uiState) {
        ...
        is DetailUiState.Success -> Column(
            ...
            ItemDetailLks(lokasi = uiState.lokasi)
            Button(
...
fun ItemDetailLks(
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ComponentDetailLks(judul = "Nama Lokasi", isinya = lokasi.nama_lokasi)
            Spacer(modifier = Modifier.height(8.dp))

            ComponentDetailLks(judul = "Id Lokasi", isinya = lokasi.id_lokasi)
            Spacer(modifier = Modifier.height(8.dp))

            ComponentDetailLks(judul = "Alamat Lokasi", isinya = lokasi.alamat_lokasi)
            Spacer(modifier = Modifier.height(8.dp))
